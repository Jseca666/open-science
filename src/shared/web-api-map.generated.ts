...
export const WEB_INVOKE_CHANNELS = {
  ...
  'compute.changeAuthentication': 'compute:change-authentication',
  'compute.concurrencySet': 'compute:concurrency:set',
  'compute.create': 'compute:create',
  'compute.createPassword': 'compute:create-password',
  'compute.delete': 'compute:delete',
  'compute.deletionStatus': 'compute:deletion-status',
  ...
  'compute.replayPendingApprovals': 'compute:approval-replay-pending',
  ...
  'memory.createCategory': 'memory:create-category',
  'memory.createEntry': 'memory:create-entry',
  'memory.deleteCategory': 'memory:delete-category',
  'memory.deleteEntry': 'memory:delete-entry',
  'memory.setEnabled': 'memory:set-enabled',
  ...
  'sessions.editDetails': 'sessions:edit-details',
  ...
  'settings.beginXaiOAuthLogin': 'settings:begin-xai-oauth-login',
  ...
  'settings.logoutXaiOAuth': 'settings:logout-xai-oauth',
  ...
  'settings.replayPendingConnectorApprovals': 'connectors:approval-replay-pending',
...
export const WEB_EVENT_CHANNELS = {
  ...
  'settings.onConnectorApprovalSettled': 'connectors:approval-settled',
